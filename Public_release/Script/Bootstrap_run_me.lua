...
--------------------------------------------------------------------------------------
 -- game
 --------------------------------------------------------------------------------------
maple.MaxRunTime = 300   --max run time in minute 
...
maple.MapRushMethod = 1             --maprush method: 0 = spawn control; 1 = packet based; 2 = Use VIP rock 
...
--------------------------------------------------------------------------------------
 -- store
 --------------------------------------------------------------------------------------
store.IfStore = 1                         -- if go to store
