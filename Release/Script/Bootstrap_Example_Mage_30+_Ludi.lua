...
maple.HuntMapList =     -- append hunt map ID, and SafeSpot here
    {
        {ID=220010400,SafeSpot={-232, -191}},
        {ID=220010300,SafeSpot={424, -71}},
    } 
...
------
maple.StopAtLevel = 50              -- stop at level = x
...
store.Potion =
   {
      ...
      BuyPotionList=
      {
         HP={ID=2000002,BuyNum=100, LowerLimit = 20},  -- go the store if pot is below the LowerLimit
         MP={ID=2000006,BuyNum=500, LowerLimit = 20},
      }
   }
...
hunt.Attack =
    {
        ...
        Range = {
            IsFan = false,
            FanMinDistance = 60,
            Front = 240,      -- attack range in front: for spear, probably 120
